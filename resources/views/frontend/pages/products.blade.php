        ...
        <div class="sec1 row mx-auto g-3">
            <div class="sec1-card col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="card-content">
                    <img class="cardImg1" src="{{ asset('frontend') }}/image/cardImage/Blue-Aqua-Mini-350-ml-Bottle-105x300.png" alt="">
            ...
            <div class="sec1-card col-lg-4 col-md-4 col-sm-12 col-xs-12">
                <div class="card-content">
                    <img class="cardImg1" src="{{ asset('frontend') }}/image/cardImage/Blue-Aqua-Mini-500-ml-bottle-109x300.png" alt="">
                    <p style="text-align: center; font-weight: bold; color: rgb(1, 29, 29);  font-size: 20px;">500 ML
                        Bottle</p>
                    <p
                        style=" text-align:center; font-size: 30px; font-weight: bold; color: red; padding-bottom: 12px;">
                        (coming soon)</p>
            ...
            <div class="sec1-card col-lg-4 col-md-4 col-sm-12 col-xs-12 ">
                <div class="card-content">
                    <img class="cardImg1" src="{{ asset('frontend') }}/image/cardImage/Blue-Aqua-1-litter-Bottle-98x300.png" alt="">
                    <p style="text-align: center; font-weight: bold; color: rgb(1, 29, 29); font-size: 20px;">300 ML
                        Bottle</p>
                    <p
                        style=" text-align:center; font-size: 30px; font-weight: bold; color: red; padding-bottom: 12px;">
