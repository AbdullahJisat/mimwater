...
<section class="content">
    ...
    <div class="row ImageFlex-P mx-auto g-3">
        @foreach ($productionFacilities->take(6) as $productionFacility)
        <div class="modalimage col-lg-4 col-md-6 col-sm-12 ">
            <img class="modal-target1" alt="Img 1" src="{{ (!empty($productionFacility->image)) ? $productionFacility->image : asset('noImage.png') }}" />
        </div>
        @endforeach
    </div>
