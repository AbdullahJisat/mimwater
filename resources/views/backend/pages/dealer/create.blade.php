        ...
        <div class="card-block">
            <form id="dealerForm" method="post" action="{{ (@$dealer) ? route('dealers.update', $dealer->id) : route('dealers.store') }}" novalidate>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                            <input type="text" class="form-control" name="shopname" id="shopname"  placeholder="Enter your shopname"
                            title="Enter shop name"  value="{{ (@$dealer) ? $dealer->shopname :old('shopname') }}" />
                    ...
                    <div class="col-sm-10">
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
                                <input class="form-check-input" type="radio" name="status" id="status" value="1"> Active
                            </label>
                        </div>
                        <div class="form-check form-check-inline">
                            <label class="form-check-label">
